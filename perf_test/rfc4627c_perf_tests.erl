...
encode1_test() ->
	...
	Obj4 = {obj, lists:map(fun(X)->{integer_to_list(X), Obj3} end, lists:seq(1, 10))},
	...
	test([Binary4], F1, F2, 25, Eq, 100),
	
	test([Obj1], F1, F2, 26, Eq, 100),	
	test([Obj2], F1, F2, 27, Eq, 100),	
	test([Obj3], F1, F2, 28, Eq, 100),	
	test([Obj4], F1, F2, 29, Eq, 100),	
